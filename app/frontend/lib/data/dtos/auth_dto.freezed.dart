...
mixin _$AuthResponseDto {
 ...
 String get accessToken; String get refreshToken; int get userId; String get email; String get name;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,userId,email,name);

@override
String toString() {
  return 'AuthResponseDto(accessToken: $accessToken, refreshToken: $refreshToken, userId: $userId, email: $email, name: $name)';
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, int userId, String email, String name
});
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? userId = null,Object? email = null,Object? name = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  int userId,  String email,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.email,_that.name);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  int userId,  String email,  String name)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto():
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.email,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  int userId,  String email,  String name)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.email,_that.name);case _:
  return null;
...
class _AuthResponseDto implements AuthResponseDto {
  const _AuthResponseDto({required this.accessToken, required this.refreshToken, required this.userId, required this.email, required this.name});
...
/// Create a copy of AuthResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? userId = null,Object? email = null,Object? name = null,}) {
