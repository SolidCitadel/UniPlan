...
mixin _$TimetableDto {
 ...
 int get id; String get name; int get openingYear; String get semester; List<TimetableCourseDto> get excludedCourses; List<TimetableItemDto> get items;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimetableDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.openingYear, openingYear) || other.openingYear == openingYear)&&(identical(other.semester, semester) || other.semester == semester)&&const DeepCollectionEquality().equals(other.excludedCourses, excludedCourses)&&const DeepCollectionEquality().equals(other.items, items));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,openingYear,semester,const DeepCollectionEquality().hash(excludedCourses),const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'TimetableDto(id: $id, name: $name, openingYear: $openingYear, semester: $semester, excludedCourses: $excludedCourses, items: $items)';
}
...
@useResult
$Res call({
 int id, String name, int openingYear, String semester, List<TimetableCourseDto> excludedCourses, List<TimetableItemDto> items
});
...
/// Create a copy of TimetableDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? openingYear = null,Object? semester = null,Object? excludedCourses = null,Object? items = null,}) {
...
as String,excludedCourses: null == excludedCourses ? _self.excludedCourses : excludedCourses // ignore: cast_nullable_to_non_nullable
as List<TimetableCourseDto>,items: null == items ? _self.items : items // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  int openingYear,  String semester,  List<TimetableCourseDto> excludedCourses,  List<TimetableItemDto> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimetableDto() when $default != null:
return $default(_that.id,_that.name,_that.openingYear,_that.semester,_that.excludedCourses,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  int openingYear,  String semester,  List<TimetableCourseDto> excludedCourses,  List<TimetableItemDto> items)  $default,) {final _that = this;
switch (_that) {
case _TimetableDto():
return $default(_that.id,_that.name,_that.openingYear,_that.semester,_that.excludedCourses,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  int openingYear,  String semester,  List<TimetableCourseDto> excludedCourses,  List<TimetableItemDto> items)?  $default,) {final _that = this;
switch (_that) {
case _TimetableDto() when $default != null:
return $default(_that.id,_that.name,_that.openingYear,_that.semester,_that.excludedCourses,_that.items);case _:
  return null;
...
class _TimetableDto implements TimetableDto {
  const _TimetableDto({required this.id, required this.name, required this.openingYear, required this.semester, final  List<TimetableCourseDto> excludedCourses = const [], final  List<TimetableItemDto> items = const []}): _excludedCourses = excludedCourses,_items = items;
...
@override final  String semester;
 final  List<TimetableCourseDto> _excludedCourses;
@override@JsonKey() List<TimetableCourseDto> get excludedCourses {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TimetableDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.openingYear, openingYear) || other.openingYear == openingYear)&&(identical(other.semester, semester) || other.semester == semester)&&const DeepCollectionEquality().equals(other._excludedCourses, _excludedCourses)&&const DeepCollectionEquality().equals(other._items, _items));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,openingYear,semester,const DeepCollectionEquality().hash(_excludedCourses),const DeepCollectionEquality().hash(_items));
...
/// Create a copy of TimetableDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? openingYear = null,Object? semester = null,Object? excludedCourses = null,Object? items = null,}) {
  return _then(_TimetableDto(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,openingYear: null == openingYear ? _self.openingYear : openingYear // ignore: cast_nullable_to_non_nullable
as int,semester: null == semester ? _self.semester : semester // ignore: cast_nullable_to_non_nullable
as String,excludedCourses: null == excludedCourses ? _self._excludedCourses : excludedCourses // ignore: cast_nullable_to_non_nullable
as List<TimetableCourseDto>,items: null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<TimetableItemDto>,
  ));
}
...
mixin _$TimetableItemDto {
 ...
 int get id; int get courseId; String get courseName; String get professor; String? get classroom; List<ClassTimeDto> get classTimes;
...
@override
String toString() {
  return 'TimetableItemDto(id: $id, courseId: $courseId, courseName: $courseName, professor: $professor, classroom: $classroom, classTimes: $classTimes)';
}
...
@useResult
$Res call({
 int id, int courseId, String courseName, String professor, String? classroom, List<ClassTimeDto> classTimes
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimetableItemDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)  $default,) {final _that = this;
switch (_that) {
case _TimetableItemDto():
return $default(_that.id,_that.courseId,_that.courseName,_that.professor,_that.classroom,_that.classTimes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)?  $default,) {final _that = this;
switch (_that) {
case _TimetableItemDto() when $default != null:
return $default(_that.id,_that.courseId,_that.courseName,_that.professor,_that.classroom,_that.classTimes);case _:
  return null;
...
class _TimetableItemDto implements TimetableItemDto {
  const _TimetableItemDto({required this.id, required this.courseId, required this.courseName, required this.professor, this.classroom, final  List<ClassTimeDto> classTimes = const []}): _classTimes = classTimes;
...
/// @nodoc
mixin _$TimetableCourseDto {

 int get courseId; String get courseName; String get professor; String? get classroom; List<ClassTimeDto> get classTimes;
/// Create a copy of TimetableCourseDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TimetableCourseDtoCopyWith<TimetableCourseDto> get copyWith => _$TimetableCourseDtoCopyWithImpl<TimetableCourseDto>(this as TimetableCourseDto, _$identity);

  /// Serializes this TimetableCourseDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimetableCourseDto&&(identical(other.courseId, courseId) || other.courseId == courseId)&&(identical(other.courseName, courseName) || other.courseName == courseName)&&(identical(other.professor, professor) || other.professor == professor)&&(identical(other.classroom, classroom) || other.classroom == classroom)&&const DeepCollectionEquality().equals(other.classTimes, classTimes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,courseId,courseName,professor,classroom,const DeepCollectionEquality().hash(classTimes));

@override
String toString() {
  return 'TimetableCourseDto(courseId: $courseId, courseName: $courseName, professor: $professor, classroom: $classroom, classTimes: $classTimes)';
}
...
/// @nodoc
abstract mixin class $TimetableCourseDtoCopyWith<$Res>  {
  factory $TimetableCourseDtoCopyWith(TimetableCourseDto value, $Res Function(TimetableCourseDto) _then) = _$TimetableCourseDtoCopyWithImpl;
@useResult
$Res call({
 int courseId, String courseName, String professor, String? classroom, List<ClassTimeDto> classTimes
});
...
/// @nodoc
class _$TimetableCourseDtoCopyWithImpl<$Res>
    implements $TimetableCourseDtoCopyWith<$Res> {
  _$TimetableCourseDtoCopyWithImpl(this._self, this._then);

  final TimetableCourseDto _self;
  final $Res Function(TimetableCourseDto) _then;

/// Create a copy of TimetableCourseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? courseId = null,Object? courseName = null,Object? professor = null,Object? classroom = freezed,Object? classTimes = null,}) {
  return _then(_self.copyWith(
...
/// Adds pattern-matching-related methods to [TimetableCourseDto].
extension TimetableCourseDtoPatterns on TimetableCourseDto {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TimetableCourseDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TimetableCourseDto() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TimetableCourseDto value)  $default,){
final _that = this;
switch (_that) {
case _TimetableCourseDto():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TimetableCourseDto value)?  $default,){
final _that = this;
switch (_that) {
case _TimetableCourseDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimetableCourseDto() when $default != null:
return $default(_that.courseId,_that.courseName,_that.professor,_that.classroom,_that.classTimes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)  $default,) {final _that = this;
switch (_that) {
case _TimetableCourseDto():
return $default(_that.courseId,_that.courseName,_that.professor,_that.classroom,_that.classTimes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int courseId,  String courseName,  String professor,  String? classroom,  List<ClassTimeDto> classTimes)?  $default,) {final _that = this;
switch (_that) {
case _TimetableCourseDto() when $default != null:
return $default(_that.courseId,_that.courseName,_that.professor,_that.classroom,_that.classTimes);case _:
  return null;
...
class _TimetableCourseDto implements TimetableCourseDto {
  const _TimetableCourseDto({required this.courseId, required this.courseName, required this.professor, this.classroom, final  List<ClassTimeDto> classTimes = const []}): _classTimes = classTimes;
  factory _TimetableCourseDto.fromJson(Map<String, dynamic> json) => _$TimetableCourseDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TimetableCourseDtoCopyWith<_TimetableCourseDto> get copyWith => __$TimetableCourseDtoCopyWithImpl<_TimetableCourseDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TimetableCourseDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TimetableCourseDto&&(identical(other.courseId, courseId) || other.courseId == courseId)&&(identical(other.courseName, courseName) || other.courseName == courseName)&&(identical(other.professor, professor) || other.professor == professor)&&(identical(other.classroom, classroom) || other.classroom == classroom)&&const DeepCollectionEquality().equals(other._classTimes, _classTimes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,courseId,courseName,professor,classroom,const DeepCollectionEquality().hash(_classTimes));
...
/// @nodoc
abstract mixin class _$TimetableCourseDtoCopyWith<$Res> implements $TimetableCourseDtoCopyWith<$Res> {
  factory _$TimetableCourseDtoCopyWith(_TimetableCourseDto value, $Res Function(_TimetableCourseDto) _then) = __$TimetableCourseDtoCopyWithImpl;
@override @useResult
$Res call({
 int courseId, String courseName, String professor, String? classroom, List<ClassTimeDto> classTimes
});
...
/// @nodoc
class __$TimetableCourseDtoCopyWithImpl<$Res>
    implements _$TimetableCourseDtoCopyWith<$Res> {
  __$TimetableCourseDtoCopyWithImpl(this._self, this._then);

  final _TimetableCourseDto _self;
  final $Res Function(_TimetableCourseDto) _then;

/// Create a copy of TimetableCourseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? courseId = null,Object? courseName = null,Object? professor = null,Object? classroom = freezed,Object? classTimes = null,}) {
  return _then(_TimetableCourseDto(
courseId: null == courseId ? _self.courseId : courseId // ignore: cast_nullable_to_non_nullable
as int,courseName: null == courseName ? _self.courseName : courseName // ignore: cast_nullable_to_non_nullable
as String,professor: null == professor ? _self.professor : professor // ignore: cast_nullable_to_non_nullable
as String,classroom: freezed == classroom ? _self.classroom : classroom // ignore: cast_nullable_to_non_nullable
